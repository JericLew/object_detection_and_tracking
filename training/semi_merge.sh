...
# FOR label merge
python ~/tracking_ws/training/merge_class/semi_merge.py ~/datasets/semi_merge/labels/

# FOR train / val split
python ~/tracking_ws/training/train_val_splitter/train_val_splitter_random.py ~/datasets/semi_merge 0.7